#!/usr/bin/env python
# -*- coding:utf-8 -*-
# 今日头条 小视频下载器    by Final Fantasy  2018-12-24
# 2018-12-24 21:00 修复文件名可能含特殊字符而出错的bug
# 2018-12-25 11:00 增加链接检测
# 2018-12-25 16:40 修复无标题视频文件名bug
# 2019-01-04 15:40 修复bug
# 2019-01-25 18:50 修复bug
# 2019-05-13 11:30 更新api修复不能下载问题，默认下载最高画质(1080P,如有)
# 2019-06-24 13:10 支持视频及小视频下载
，bug修复
